...
public class AIControls : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // ou will need to ask waypointsHolder to get the components in its children of type Transform and use the result to initialize the List<Transform> waypoints.
        
        waypoints = new List<Transform>(waypointsHolder.GetComponentsInChildren<Transform>());
